...
export default function ContactoPage() {
  return (
    <Section tone="white" rhythm="air" className="relative overflow-hidden pt-40 lg:pt-52">
      <Container>
        <div className="grid border-l border-t border-hairline lg:grid-cols-12">
          <div className="border-b border-r border-hairline p-8 lg:col-span-5 lg:p-14">
            <Eyebrow className="text-labs-ink">Contacto</Eyebrow>
          ...
          <div className="border-b border-r border-hairline bg-blue p-8 text-white lg:col-span-7 lg:p-14">
